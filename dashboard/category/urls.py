...
urlpatterns = [
    path(
        "create/",
        user_dashboard_permission(views.CreateCategory.as_view()),
        name="category_create",
    ),
    path(
        "create/<int:pk>/",
        user_dashboard_permission(views.CreateSubCategory.as_view()),
    ...
    path(
        "delete/<int:pk>",
        user_dashboard_permission(views.delete_category),
